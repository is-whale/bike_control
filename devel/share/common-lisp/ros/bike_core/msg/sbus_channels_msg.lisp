...
(cl:defmethod cl:initialize-instance :after ((m <sbus_channels_msg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'sbus_channels_msg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name bike_core-msg:<sbus_channels_msg> is deprecated: use bike_core-msg:sbus_channels_msg instead.")))
...
(cl:defmethod channels_value-val ((m <sbus_channels_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bike_core-msg:channels_value-val is deprecated.  Use bike_core-msg:channels_value instead.")
  (channels_value m))
